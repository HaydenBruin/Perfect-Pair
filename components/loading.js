        ...
        return (
            <div className="loading">
                <svg width="125px"  height="125px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                    <circle cx="50" cy="50" fill="none" stroke="#FEA47F" strokeWidth="8" r="35" strokeDasharray="164.93361431346415 56.97787143782138" transform="rotate(359.784 50.0036 50.0036)">
