        ...
        return (
            <DefaultLayout>
                <div className="container">
                    ...
                    <h3>Targeting and Advertising</h3>
                    The social media sharing functionality on certain web pages is provided by the third party AddThis.&nbsp; As you navigate these pages or if you use the sharing buttons, AddThis will automatically set cookies. We have no control over the cookies that AddThis uses. You can opt out of addthis.com cookies at&nbsp;<a href="http://www.addthis.com/privacy/opt-out" target="_blank" rel="noopener">http://www.addthis.com/privacy/opt-out</a>.
                    ...
                    All recent versions of popular browsers give you a level of control over cookies. You can set your browser to accept or reject all, or certain, cookies.&nbsp; For instructions on how to manage cookies, please read the 'Help' section of your browser or visit our guide at&nbsp;<a href="https://www.aboutcookies.org/" target="_blank" rel="noopener">www.aboutcookies.org</a>.

                    Please be aware that some areas of our website may not function after you have changed your cookie settings.
                    <h2>Contact</h2>
                    If you have any queries concerning our use of your personal information, please email support@perfectpair.nz.
                </div>
            </DefaultLayout>
        )
    }
